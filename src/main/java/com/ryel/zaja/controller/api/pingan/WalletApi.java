...
public class WalletApi {
    ...
    public Result outToCommon(Integer outUserId,Integer inUserId,String messageCode) {
        HashMap parmaKeyDict = new HashMap();// 用于存放生成向银行请求报文的参数
        HashMap retKeyDict = new HashMap();// 用于存放银行发送报文的参数
        try {
